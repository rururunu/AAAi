...
```powershell
pnpm release:json -- --tag v0.2.0 --notes "更新说明（可选）"
```
...
```json
{
  ...
  "platforms": {
    "windows-x86_64": {
      "url": "https://github.com/rururunu/AAAi/releases/download/v0.2.0/AAAi_0.2.0_x64.msi",
      "signature": "<AAAi_0.2.0_x64.msi.sig 文件的全部内容>"
    }
  }
}
```
