...
export const workspaceLocales: Record<AppLanguage, WorkspaceLocalePartial> = {
  ...
  "ja-JP": {
    ...
    "workspace.deleteConfirm": "ワークスペース「{name}」を削除しますか？プロジェクトファイルは削除されません。",
  },
  "ru-RU": {
    "workspace.title": "Рабочие области",
    "workspace.description": "Текущая рабочая область используется как корень проекта для новых чатов.",
  ...
  "de-DE": {
    ...
    "workspace.description": "Der aktuelle Arbeitsbereich ist das Projektstammverzeichnis für neue Chats.",
    ...
    "workspace.deleteConfirm": "Arbeitsbereich „{name}“ löschen? Projektdateien werden nicht gelöscht.",
  },
  "fr-FR": {
    "workspace.title": "Espaces de travail",
    "workspace.description": "L’espace de travail actuel est la racine du projet pour les nouvelles discussions.",
    ...
    "workspace.deleteConfirm": "Supprimer l’espace de travail « {name} » ? Les fichiers du projet ne seront pas supprimés.",
  },
  "ko-KR": {
    ...
    "workspace.deleteConfirm": "작업 영역 ‘{name}’을 삭제할까요? 프로젝트 파일은 삭제되지 않습니다.",
  },
};
