...
export const settingsFieldIds = [
  ...
  "defaultModel", "multimodalModel", "multimodalSplitAnalysis", "largeContextEnabled", "reasoningEffort", "reasoningLanguage", "responseTone", "showReasoning", "passToolReasoning",
...
export const settingsEn: Record<SettingsI18nKey, string> = {
  ...
  "settings.fields.responseTone.title": "Response tone",
  "settings.fields.responseTone.description": "Choose the default writing style for model replies. Explicit instructions in a conversation take precedence.",
...
export const settingsLocales: Record<AppLanguage, Partial<Record<SettingsI18nKey, string>>> = {
  ...
  "zh-CN": {
    ...
    "settings.fields.responseTone.title": "回复语气",
    "settings.fields.responseTone.description": "选择模型回复的默认表达风格；会话中的明确要求优先。",
...
const settingsFieldPaths: Record<"zh-CN" | "en-US", Partial<Record<SettingFieldId, string>>> = {
  "en-US": {
    ...
    responseTone: "AI › Chat › Response Tone",
...
const settingsFieldKeywords: Record<"zh-CN" | "en-US", Partial<Record<SettingFieldId, string[]>>> = {
  "en-US": {
    ...
    responseTone: ["response", "tone", "style", "personality"],
  ...
  "zh-CN": {
    ...
    responseTone: ["回复", "语气", "风格", "严谨", "亲和", "抽象", "暴躁"],
